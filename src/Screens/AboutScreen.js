...
import HISTORY from '../assets/aboutus/outside.jpg'
import BANNER from '../assets/aboutus/aboutbanner.jpg'
import LIVING from '../assets/aboutus/Living.jpg'
...
const AboutScreen = () => {
    return (
        <div className='bg-[linear-gradient(_#FFFFFF_25%,_#ebf3fc_75%)]  '>
            ...
            {/*Banner*/}
            <div className='pb-5'>
                <div className='h-80 bg-center bg-cover brightness-75 font-bold ' style={{ backgroundImage: `url(${BANNER})` }}>

                    <h1 className='flex h-full items-center justify-center ' >About Us</h1>
                ...
                <div>
                    ...
                    <div className="hero min-h-full animate__animated animate__fadeInLeftBig ">
                        <div className="hero-content flex-col lg:flex-row">
                            <img src={HISTORY} className="max-w-sm rounded-lg shadow-2xl" alt='' />
                    ...
                    <div className="hero min-h-full animate__animated animate__fadeInRightBig animate__delay-1s py-4">
                        <div className="hero-content flex-col lg:flex-row-reverse">
                            <img src={LIVING} className="max-w-sm rounded-lg shadow-2xl" alt='' />
                            <div className='text-center'>
                    ...
                    <div className="hero min-h-full animate__animated animate__fadeInLeftBig animate__delay-2s ">
                        <div className="hero-content flex-col lg:flex-row">
                            <img src={REHAB} className="max-w-sm rounded-lg shadow-2xl" alt='' />
                            <div className='text-center'>
                    ...
                    <div className="hero min-h-full animate__animated animate__fadeInRightBig animate__delay-4s py-4">
                        <div className="hero-content flex-col lg:flex-row-reverse">
                            <img src={SPECI} className="max-w-sm rounded-lg shadow-2xl" alt='' />
                            <div className='text-center'>
                    ...
                    <div className="hero min-h-full animate__animated animate__fadeInLeftBig animate__delay-4s pb-4 ">
                        <div className="hero-content flex-col lg:flex-row">
                            <img src={MEDICAL} className="max-w-sm rounded-lg shadow-2xl" alt='' />
                            <div className='text-center'>
