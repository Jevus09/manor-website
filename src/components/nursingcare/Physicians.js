    ...
    return (
        <div>
            ...
            <div className='flex w-full justify-evenly items-center pt-12 text-center '>
                <h2>BOARD CERTIFIED PHYSICIANS</h2>
            </div>
            <div className='flex justify-center items-center py-6  '>
                <div
                    className='bg-white w-5/6 md:w-3/6 py-4 flex flex-col justify-center items-center rounded-sm'
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center place-content-center px-4 xl:px-20 py-20   ' >
                {Data.map((item) =>
                    item.id % 2 === 0 ? (
                        ...
                        <div key={item.id} className='w-11/12 h-16 flex justify-between items-center bg-white md:hover:scale-110 duration-500 rounded-xl' style={{ boxShadow: 'rgb(38, 57, 77) 0px 20px 30px -10px' }}>
                            <div className='h-full flex items-center w-4/6'>
