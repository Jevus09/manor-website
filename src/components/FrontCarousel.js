...
import first from '../assets/carousel/home.webp';
      ...
      <Carousel>
        ...
        <Carousel.Item >
          ...
          <Carousel.Caption >
            ...
            <a href='/#' className=" border border-line px-3 py-2 rounded-full text-white no-underline hidden sm:inline-block ">Get in Touch</a>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
    </div>
