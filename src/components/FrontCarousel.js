    ...
    <div>
      <Carousel>
        ...
        <Carousel.Item >
          ...
          <div className="">
            <Carousel.Caption className="h-72 ">
              <h1 className="text-3xl md:text-6xl italic  " style={{ maxHeight: '4vh' }}>Our Family to Yours</h1>
              ...
              <a href='/contact' className=" border border-line px-3 py-2 rounded-full text-white no-underline hidden sm:inline-block">Get in Touch</a>
            </Carousel.Caption>
          </div>
        </Carousel.Item>
        ...
        <Carousel.Item >
          ...
          <Carousel.Caption >
            <h1 className=" text-3xl md:text-6xl " style={{ maxHeight: '4vh' }} >Therapy You Can Trust</h1>
        ...
        <Carousel.Item >
          ...
          <Carousel.Caption >
            <h1 className="text-3xl md:text-6xl" style={{ maxHeight: '10vh' }}>Excellence in Care</h1>
